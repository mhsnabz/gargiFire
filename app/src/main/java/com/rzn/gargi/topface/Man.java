...
public class Man extends Fragment {
    ...
    boolean isScrolling,isLastItemReach ;
    DocumentSnapshot lastvisible;
    FirestorePagingAdapter<ModelUser ,ViewHolder> adapter;
    public Man() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // setRecyclerView(rootView,man);
        ...
        man = rootView.findViewById(R.id.manUsers);
        man.setHasFixedSize(true);
        man.setLayoutManager(linearLayoutManager);
    ...
    private void ListPagin(Query query){
       ...
       adapter = new FirestorePagingAdapter<ModelUser, ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return  new Man.ViewHolder(itemView);
            }
        };

        man.setAdapter(adapter);
    }
